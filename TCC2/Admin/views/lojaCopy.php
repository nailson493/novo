                        ...
                        <div  class="mt-10 sm:mt-0 ">
                            <div id="full" class="md:grid md:grid-cols-3 md:gap-6">
                                <div  class="mt-5 md:col-span-2 md:mt-0  ">
                                    <form  method="POST"  runat="server" action="painelAdmin.php?r=lojaCopy" >
                                        <div  class="overflow-hidden shadow sm:rounded-md ">
                                                    <div class="bg-white sm:p-6">                                                    
                                                        <div class="grid grid-cols-6 gap-6">
                                                            <div class="col-span-6 sm:col-span-6">
                                                            <label for="establecimento-name" class="block text-sm font-medium text-gray-700">Nome</label>
                                                            <input type="text" name="nome"  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required >
                                                            </div>

                                                            <div class="col-span-3">
                                                            <label for="street-address" class="block text-sm font-medium text-gray-700">Endereço</label>
                                                            <input type="text" name="endereco"   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                                                            </div>

                                                            <div class="col-span-3">
                                                            <label for="street-address" class="block text-sm font-medium text-gray-700">Bairro</label>
                                                            <input type="text" name="bairro"  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                                                            </div>
                                            
                                                            <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                                            <label for="city" class="block text-sm font-medium text-gray-700">Cidade</label>
                                                            <input type="text" name="cidade"   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required >
                                                            </div>
                                            
                                                            <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                                            <label for="region" class="block text-sm font-medium text-gray-700">Estado</label>
                                                            <input type="text" name="estado"   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                                                            </div>
                                            
                                                            <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                                            <label for="postal-code" class="block text-sm font-medium text-gray-700">Cep</label>
                                                            <input type="text" name="cep"  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                                                            </div>   
                                                            <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                                            <label for="postal-code" class="block text-sm font-medium text-gray-700">Telefone</label>
                                                            <input type="text" name="telefone"  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                                                            </div>                                          
                                                   </div>                                                                                                              
                                                                <div class="grid grid-cols-3 gap-4 w-[32rem] mb-4 mt-10 justify-start">
                                                                    <div class="col-span-1">
                                                                        <label for="week-day" class="block text-sm font-medium text-gray-700">Segunda - Sexta</label>
                                                                    ...
                                                                    <div class="col-span-6 sm:col-span-1">
                                                                        ...
                                                                        <input type="time" step="2" name="horarioAbre" id="open-monday" value="" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                                                                    </div>
                                                                    <div class="col-span-6 sm:col-span-1">
                                                                        <label for="week-day" class="block text-sm font-medium text-gray-700">Fecha</label>
                                                                        <input type="time" step="2" name="horarioFecha" id="closed-monday"  value="" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required >
                                                                    </div>
                                                                
                                                                    <div class="col-span-1">
                                                                        <label for="week-day" class="block text-sm font-medium text-gray-700">Sábado</label>
                                                                    ...
                                                                    <div class="col-span-6 sm:col-span-1">
                                                                        ...
                                                                        <input type="time" step="2" name="sabadoAbre" id="open-tuesday" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                                                                    </div>
                                                                    <div class="col-span-6 sm:col-span-1">
                                                                        <label for="week-day" class="block text-sm font-medium text-gray-700">Fecha</label>
                                                                        <input type="time" step="2" name="sabadoFecha" id="closed-tuesday" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                                                                    </div>
  ...
  if(cadastrar($_POST)){ ?>        
    ...
    <script language='javascript'>
      ...
      swal.fire({ 
        ...
        type: "success"}).then(okay => {
          if (okay) {
            window.location.href = "painelAdmin.php?r=lojaCopy";
          }
        });
      </script>
 <?php } 
