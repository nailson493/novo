    ...
    <!-- ocultado search -->
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        ...
        <ul class="flex flex-col p-4 mt-4  md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 ">
          <li>
            <a href="painel.php?r=inicial" class="block py-2 pl-3 pr-4 text-white left-20 text-[20px] relative bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">Home</a>
          </li>
